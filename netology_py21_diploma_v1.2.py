...
class User:
    ...
    def get_groups_or_friends_ids(self, groups_or_friends):
        ...
        response = requests.get('https://api.vk.com/method/{}'.format(groups_or_friends), params)
    ...
    def get_unique_groups_ids(self):
        params = self.get_params()
        user_groups_ids = self.get_groups_or_friends_ids('groups.get')
        friends_ids = self.get_groups_or_friends_ids('friends.get')
